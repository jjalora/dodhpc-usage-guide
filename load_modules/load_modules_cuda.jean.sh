...
if [ -r /p/app/CSE/CSE/Release/Miniforge3-24.11.2-1/etc/profile.d/conda.sh ]; then
    ...
    echo "WARN: conda hook not found at /p/app/CSE/CSE/Release/Miniforge3-24.11.2-1/etc/profile.d/conda.sh" >&2
fi
